        ...
        <div id="main" style="padding-bottom: 30px">
            ...
            <div id="site_content">		
                ...
                <div id="content">
                    ...
                    <div>    
                        <div style="margin:40px;float:left;border-radius: 75px;height:150px;width:150px;border:2px solid white;background-image:url(images/pic.jpg);background-repeat: no-repeat"></div>     
                        <div style="margin-top:70px;float:left;width:600px;height:150px;margin-left: 30px">    
                            <label class="mylabel" style="font-size: 25px;color: white;">Aniket R. Patil</label>
                            <div style="width:700px;height:60px;margin-top: 5px">
                                <label style="font-size:15px ;color:white "><br>Currently  studying  MCA  (1st year) <br></label>
                            </div>
                        </div>
                    </div>
                    <br>
