        ...
        <div id="main"  style="padding-bottom: 30px;">
            ...
            <div id="menubar">
                <ul id="menu">
                    ...
                    <li><a href="vote_Section2.jsp">Apply For</a></li>
                ...
                <div class="slideshow">
                    <ul class="slideshow">
                        <div id="wowslider-container1">
                            <div class="ws_images">
                                <ul>
                                    <li><img style="height: 250px;width: 880px" src="data1/images/pic1.jpg" alt="IICMR Nigdi Campus"  id="wows1_0"/></li>
                                    <li><img style="height: 250px;width: 880px" src="data1/images/pic2.jpg" alt="IICMR Nigdi Campus" id="wows1_1"/></li>
                                    <li><img style="height: 250px;width: 880px" src="data1/images/pic3.jpg" alt="IICMR Nigdi Campus" id="wows1_2"/></li>
                                </ul></div>
                ...
                <div id="content">
                    <div class="content_item">
                        <div class="form_settings">
                            ...
                            <p>&nbsp;</p>
                            <form name="comment">
                                <p><span>Name</span><input class="contact" type="text" name="name" value="<%=session.getAttribute("login1")%>" /></p>
                                <p><span>Email Address</span><input class="contact" type="text" name="email" value="<%=session.getAttribute("login2")%>" /></p>
