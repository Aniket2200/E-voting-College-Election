  ...
  window.location.href=("../index.html");
        ...
        <div class="module form-module">
            ...
            <div class="form">
                ...
                <form name="register">
                    ...
                    <button name="reg" onclick="return ">Register</button>
                </form>
            </div>
        ...
        <%
            if (request.getParameter("reg") != null) {     // if user clicks on the register button and submiited his details
                ...
                try {
                    ...
                    String query = "select * from student1";             // student is the table where information about the registered users are stored
        ...
        <%
            ...
            if (flag == 0) {
                ...
                // sending mail to the user
                    ...
                    PreparedStatement k = con.prepareStatement("insert into student1 values(?,?,?,?,?,?,?,?,?,?,?,?)");
                    k.setString(1, a);
                    k.setString(2, d);
                    k.setString(3, b);
                    k.setString(4, c);
        ...
        <%
            if (request.getParameter("log") != null) {    // if user logins into site
                ...
                String me = "select * from student1 where username='" + a + "' and password='" + b + "'";
